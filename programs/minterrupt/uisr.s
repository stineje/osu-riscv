.section .text
.global __u_trap_handler
.type __u_trap_handler, @function
...
# select	 which system call based on a7.
	...
	# check a7
	li	t0, 1
	beq	a7, t0, trap_u_ecall_skip_cb
	li	t0, 2
	beq	a7, t0, trap_u_ecall_skip_cb
	...
	lw	t0, 0(t1)
	beq	t0, x0, trap_u_ecall_skip_cb
	jalr	ra, t0, 0
trap_u_ecall_skip_cb:	
	# modify the mepc
	csrrw	t0, uepc, x0
	addi	t0, t0, 4
	csrrw	x0, uepc, t0
