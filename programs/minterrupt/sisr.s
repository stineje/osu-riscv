.section .text
.global __s_trap_handler
.type __s_trap_handler, @function
...
__s_trap_handler:
	...
	csrrw t0, scause, x0
	# scause is {int, 31 bit exception code}
...
trap_s_ecall:
	...
	# check a7
	li	t0, 1
	beq	a7, t0, trap_s_decrease_privilege
	li	t0, 2
	beq	a7, t0, trap_s_increase_privilege
	
	# call call back function if not zero
	la	t1, isr_s_ecall_cb_fp
	lw	t0, 0(t1)
	beq	t0, x0, trap_s_ecall_skip_cb
	jalr	ra, t0, 0
trap_s_ecall_skip_cb:	
	# modify the mepc
	csrrw	t0, sepc, x0
	addi	t0, t0, 4
	csrrw	x0, sepc, t0
...
trap_s_decrease_privilege:
	# read the mstatus register
	csrrw	t0, sstatus, x0
	# 11 => 01, and 01 => 00.
	# this is accomplished by clearing bit 8
	li	t3, ~0x00000100
	and	t0, t0, t3 
	csrrw	x0, sstatus, t0
	j	trap_s_ecall_skip_cb

trap_s_increase_privilege:
	# read the mstatus register
	csrrw	t0, sstatus, x0
	# this is accomplished by setting bit 8.
	li	t3, 0x00000100
	or	t0, t0, t3
	csrrw	x0, sstatus, t0
	j 	trap_s_ecall_skip_cb
